...
class VOCDataset(torch.utils.data.Dataset): 
    def __init__( 
        self, csv_file, image_dir, label_dir, anchors, is_test=False, 
        ...
        # Whether it's used in test time
    ...
    def __getitem__(self, idx): 
        ...
        if self.is_test: # During the test time, just return the image & the bboxes
            return image, bboxes
        ...
        # Return the im {"targets": age and the target 
